...
\begin{titlepage}
    ...
    {\Large {Autor: Ovidio Navarro Pazos}}\\[2cm]
   	{\Large {Tutor(es): M.Sc. Lisset Suárez Plasencia}}\\
   	\hspace{8.5em}{\Large{M.Sc. Joaquín A. Herrera Macías}}\\
   	\hspace{8.5em}{\Large{Dr.C. Carlos Miguel Legón Pérez}}\\
   	[2.0cm]
